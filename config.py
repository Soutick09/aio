...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7968053738:AAGcctGNro2-yJj00iV6SMwPI5Sf-YzNKxU")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002413274195"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {mention} 👋! I'm Alya.\n\nI'm only Work for @AIO_Backup...!\n\nPlease don't Overload me 😒")
try:
    ADMINS=[]
